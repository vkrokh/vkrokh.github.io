...
window.onload = function () {
    ...
    canvas.onmousemove = function (event) {
        if (click_count == 1) {
            ...
            document.getElementById('position').value = lengthValue;
            document.getElementById('len').value = (0.007 * (parseFloat(lengthValue) + (dy / (parseFloat(img.height)*100)))) / (dy / (parseFloat(img.height)*100)) + ' M';
